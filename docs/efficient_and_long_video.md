...
- [Improving Temporal Action Segmentation via Constraint-Aware Decoding](https://icpr2026.org/acceptedPapersTrack.html) — ICPR 2026; `structured-decoding, boundary-modeling`
...
- [Learning Action Hierarchies via Hybrid Geometric Diffusion](https://openaccess.thecvf.com/content/WACV2026/html/Kaushik_Learning_Action_Hierarchies_via_Hybrid_Geometric_Diffusion_WACV_2026_paper.html) — WACV 2026; `diffusion, prototype-learning`
...
- [End-to-End Action Segmentation Transformer](https://openaccess.thecvf.com/content/ICCV2025W/SVU/html/Wang_End-to-End_Action_Segmentation_Transformer_ICCVW_2025_paper.html) — ICCV Workshop 2025; `Transformer, boundary-modeling`
...
- [Towards Open-World Human Action Segmentation Using Graph Convolutional Networks](https://doi.org/10.1109/IROS60139.2025.11247257) — IROS 2025; `graphical-model, open-world`
...
- [Efficient Temporal Action Segmentation via Boundary-aware Query Voting](https://proceedings.neurips.cc/paper_files/paper/2024/hash/42770daf4a3384b712ea9c36e9279998-Abstract-Conference.html) — NeurIPS 2024; `Transformer, boundary-modeling`
...
- [Boundary-Aware Cascade Networks for Temporal Action Segmentation](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/35_ECCV_2020_paper.php) — ECCV 2020; `TCN, boundary-modeling`
