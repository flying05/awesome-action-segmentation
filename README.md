...
| View | Counts |
|---|---|
| By venue | AAAI: 2; ACM MM Workshop: 1; BMVC: 3; CVPR: 36; CVPR Workshop: 3; ECCV: 10; ICCV: 15; ICCV Workshop: 1; ICRA: 1; IJCAI: 2; IROS: 1; MICCAI: 1; NeurIPS: 5; WACV: 10 |
| By year | 2026: 8; 2025: 9; 2024: 15; 2023: 8; 2022: 16; 2021: 10; 2020: 10; 2019: 5; 2018: 4; 2017: 2; 2016: 2; 2015: 1; 2014: 1 |
...
- **End-to-End Action Segmentation Transformer** — Tieqiao Wang, Sinisa Todorovic, ICCV Workshop 2025.
  [Paper](https://openaccess.thecvf.com/content/ICCV2025W/SVU/html/Wang_End-to-End_Action_Segmentation_Transformer_ICCVW_2025_paper.html) [PDF](https://openaccess.thecvf.com/content/ICCV2025W/SVU/papers/Wang_End-to-End_Action_Segmentation_Transformer_ICCVW_2025_paper.pdf) [Code](https://github.com/tqosu/EAST)
...
- **Pose-Aware Weakly-Supervised Action Segmentation** — Zhihao Zhao, Reza Ghoddoosian, Isht Dwivedi, et al., CVPR Workshop 2025.
  [Paper](https://openaccess.thecvf.com/content/CVPR2025W/MULA2025/html/Zhao_Pose-Aware_Weakly-Supervised_Action_Segmentation_CVPRW_2025_paper.html) [PDF](https://openaccess.thecvf.com/content/CVPR2025W/MULA2025/papers/Zhao_Pose-Aware_Weakly-Supervised_Action_Segmentation_CVPRW_2025_paper.pdf)
...
- **Timestamp-Supervised Action Segmentation with Graph Convolutional Networks** — Hamza Khan, Sanjay Haresh, Awais Ahmed, et al., IROS 2022.
  ...
  `timestamp-supervised` `graphical-model` `TCN` `unknown`
...
- **Iterative Contrast-Classify for Semi-Supervised Temporal Action Segmentation** — Dipika Singhania, Rahul Rahaman, Angela Yao, AAAI 2022.
  ...
  `semi-supervised` `contrastive-learning` `clustering` `unknown`
...
- **Hierarchical Vector Quantization for Unsupervised Action Segmentation** — Federico Spurio, Emad Bahrami, Gianpiero Francesca, et al., AAAI 2025.
  ...
  `unsupervised` `VQ-tokenization` `clustering` `unknown`
...
- **Leveraging Triplet Loss for Unsupervised Action Segmentation** — Elena Belen Bueno-Benito, Biel Tura Vecino, Mariella Dimiccoli, CVPR Workshop 2023.
  [Paper](https://openaccess.thecvf.com/content/CVPR2023W/L3D-IVU/html/Bueno-Benito_Leveraging_Triplet_Loss_for_Unsupervised_Action_Segmentation_CVPRW_2023_paper.html) [PDF](https://openaccess.thecvf.com/content/CVPR2023W/L3D-IVU/papers/Bueno-Benito_Leveraging_Triplet_Loss_for_Unsupervised_Action_Segmentation_CVPRW_2023_paper.pdf)
...
<a id="paper-2026-preprint-deep-kernel-approximation-unsupervised"></a>
- **Deep kernel video approximation for unsupervised action segmentation** — Silvia L. Pintea, Jouke Dijkstra, Preprint 2026.
  [PDF](https://arxiv.org/pdf/2604.21572) [arXiv](https://arxiv.org/abs/2604.21572)
  `unsupervised` `optimal-transport` `IMU`
  _Status:_ arXiv 2604.21572; first submitted 2026-04-23; last updated 2026-04-23; comment=Accepted at ICPR 2026; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2026-preprint-hoi-aware-adaptive-network-weakly"></a>
- **HOI-aware Adaptive Network for Weakly-supervised Action Segmentation** — Runzhong Zhang, Suchen Wang, Yueqi Duan, et al., Preprint 2026.
  [PDF](https://arxiv.org/pdf/2604.26227) [arXiv](https://arxiv.org/abs/2604.26227)
  `weakly-supervised` `unknown` `unknown` `Breakfast` `50Salads`
  _Status:_ arXiv 2604.26227; first submitted 2026-04-29; last updated 2026-04-29; comment=Accepted to IJCAI 2023; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2026-preprint-improving-constraint-aware-decoding"></a>
- **Improving Temporal Action Segmentation via Constraint-Aware Decoding** — Yeo Keat Ee, Debaditya Roy, Chen Li, et al., Preprint 2026.
  [PDF](https://arxiv.org/pdf/2605.10149) [arXiv](https://arxiv.org/abs/2605.10149)
  `semi-supervised` `boundary-modeling` `duration-modeling` `unknown`
  _Status:_ arXiv 2605.10149; first submitted 2026-05-11; last updated 2026-05-11; comment=accepted to ICPR 2026; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2025-preprint-multi-modal-graph-convolutional-network"></a>
- **Multi-Modal Graph Convolutional Network with Sinusoidal Encoding for Robust Human Action Segmentation** — Hao Xing, Kai Zhe Boey, Yuankai Wu, et al., Preprint 2025.
  [PDF](https://arxiv.org/pdf/2507.00752) [arXiv](https://arxiv.org/abs/2507.00752)
  `fully-supervised` `unknown` `skeleton`
  _Status:_ arXiv 2507.00752; first submitted 2025-07-01; last updated 2025-12-11; comment=8 pages, 5 figures, accepted in IROS25, Hangzhou, China; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2025-preprint-towards-open-world-human-using"></a>
- **Towards Open-World Human Action Segmentation Using Graph Convolutional Networks** — Hao Xing, Kai Zhe Boey, Gordon Cheng, Preprint 2025.
  [PDF](https://arxiv.org/pdf/2507.00756) [arXiv](https://arxiv.org/abs/2507.00756)
  `fully-supervised` `clustering` `depth`
  _Status:_ arXiv 2507.00756; first submitted 2025-07-01; last updated 2025-12-11; comment=8 pages, 3 figures, accepted in IROS25, Hangzhou, China; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2024-preprint-stitch-contrast-segment-learning-human"></a>
- **Stitch Contrast and Segment_Learning a Human Action Segmentation Model Using Trimmed Skeleton Videos** — Haitao Tian, Pierre Payeur, Preprint 2024.
  [PDF](https://arxiv.org/pdf/2412.14988) [arXiv](https://arxiv.org/abs/2412.14988)
  `fully-supervised` `unknown` `skeleton`
  _Status:_ arXiv 2412.14988; first submitted 2024-12-19; last updated 2024-12-21; comment=Accepted at AAAI 2025; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2023-preprint-using-2d-skeleton-heatmaps-multi"></a>
- **Action Segmentation Using 2D Skeleton Heatmaps and Multi-Modality Fusion** — Syed Waleed Hyder, Muhammad Usama, Anas Zafar, et al., Preprint 2023.
  [PDF](https://arxiv.org/pdf/2309.06462) [arXiv](https://arxiv.org/abs/2309.06462)
  `fully-supervised` `TCN` `skeleton`
  _Status:_ arXiv 2309.06462; first submitted 2023-09-12; last updated 2024-04-26; comment=Accepted to ICRA 2024; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2023-preprint-permutation-aware-unsupervised-frame-segment"></a>
- **Permutation-Aware Action Segmentation via Unsupervised Frame-to-Segment Alignment** — Quoc-Huy Tran, Ahmed Mehmood, Muhammad Ahmed, et al., Preprint 2023.
  [PDF](https://arxiv.org/pdf/2305.19478) [arXiv](https://arxiv.org/abs/2305.19478)
  `unsupervised` `Transformer` `optimal-transport` `unknown` `Breakfast`
  _Status:_ arXiv 2305.19478; first submitted 2023-05-31; last updated 2025-12-01; comment=Accepted to WACV 2024; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2023-preprint-taec-unsupervised-aware-embedding-clustering"></a>
- **TAEC: Unsupervised Action Segmentation with Temporal-Aware Embedding and Clustering** — Wei Lin, Anna Kukleva, Horst Possegger, et al., Preprint 2023.
  [PDF](https://arxiv.org/pdf/2303.05166) [arXiv](https://arxiv.org/abs/2303.05166)
  `unsupervised` `clustering` `unknown`
  _Status:_ arXiv 2303.05166; first submitted 2023-03-09; last updated 2023-03-09; comment=Computer Vision Winter Workshop 2023; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2022-preprint-parsing-using-context-features"></a>
- **Action parsing using context features** — Nagita Mehrseresht, Preprint 2022.
  [PDF](https://arxiv.org/pdf/2205.10008) [arXiv](https://arxiv.org/abs/2205.10008)
  `fully-supervised` `unknown` `unknown` `Breakfast`
  _Status:_ arXiv 2205.10008; first submitted 2022-05-20; last updated 2022-05-20; comment=none; journal_ref=International Conference on Digital Image Computing: Techniques and Applications (DICTA), 2017, pp. 1-7. No formal conference proceedings placement has been verified.
...
<a id="paper-2022-preprint-streaming-real-time"></a>
- **Streaming Video Temporal Action Segmentation In Real Time** — Wujun Wen, Yunheng Li, Zhuben Dong, et al., Preprint 2022.
  [PDF](https://arxiv.org/pdf/2209.13808) [arXiv](https://arxiv.org/abs/2209.13808)
  `fully-supervised` `unknown` `multimodal`
  _Status:_ arXiv 2209.13808; first submitted 2022-09-28; last updated 2023-10-10; comment=accepted by ISKE2023; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2022-preprint-turning-teacher-timestamp-supervised"></a>
- **Turning to a Teacher for Timestamp Supervised Temporal Action Segmentation** — Yang Zhao, Yan Song, Preprint 2022.
  [PDF](https://arxiv.org/pdf/2207.00712) [arXiv](https://arxiv.org/abs/2207.00712)
  `timestamp-supervised` `unknown` `unknown`
  _Status:_ arXiv 2207.00712; first submitted 2022-07-02; last updated 2022-07-02; comment=6 pages, ICME 2022 oral; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2020-preprint-intra-inter-understanding-parsing"></a>
- **Intra- and Inter-Action Understanding via Temporal Action Parsing** — Dian Shao, Yue Zhao, Bo Dai, et al., Preprint 2020.
  [PDF](https://arxiv.org/pdf/2005.10229) [arXiv](https://arxiv.org/abs/2005.10229)
  `fully-supervised` `unknown` `unknown`
  _Status:_ arXiv 2005.10229; first submitted 2020-05-20; last updated 2020-05-20; comment=CVPR 2020 Poster; Project page: https://sdolivia.github.io/TAPOS/; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2020-preprint-relational-modeling-self-supervision"></a>
- **Temporal Relational Modeling with Self-Supervision for Action Segmentation** — Dong Wang, Di Hu, Xingjian Li, et al., Preprint 2020.
  [PDF](https://arxiv.org/pdf/2012.07508) [arXiv](https://arxiv.org/abs/2012.07508)
  `self-supervised` `unknown` `unknown` `Breakfast` `50Salads`
  _Status:_ arXiv 2012.07508; first submitted 2020-12-14; last updated 2020-12-14; comment=Accepted by the Thirty-Fifth AAAI Conference on Artificial Intelligence (AAAI-21); journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2019-preprint-coupled-generative-adversarial-network-continuous"></a>
- **Coupled Generative Adversarial Network for Continuous Fine-grained Action Segmentation** — Harshala Gammulle, Tharindu Fernando, Simon Denman, et al., Preprint 2019.
  [PDF](https://arxiv.org/pdf/1909.09283) [arXiv](https://arxiv.org/abs/1909.09283)
  `fully-supervised` `unknown` `multimodal`
  _Status:_ arXiv 1909.09283; first submitted 2019-09-20; last updated 2019-09-20; comment=WACV 2019; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2018-preprint-end-end-fine-grained-recognition"></a>
- **End-to-End Fine-Grained Action Segmentation and Recognition Using Conditional Random Field Models and Discriminative Sparse Coding** — Effrosyni Mavroudi, Divya Bhaskara, Shahin Sefati, et al., Preprint 2018.
  [PDF](https://arxiv.org/pdf/1801.09571) [arXiv](https://arxiv.org/abs/1801.09571)
  `fully-supervised` `unknown` `unknown`
  _Status:_ arXiv 1801.09571; first submitted 2018-01-29; last updated 2018-01-29; comment=Camera ready version accepted at WACV 2018; journal_ref=none. No formal conference proceedings placement has been verified.
...
<a id="paper-2016-preprint-segmental-spatiotemporal-cnns-fine-grained"></a>
- **Segmental Spatiotemporal CNNs for Fine-grained Action Segmentation** — Colin Lea, Austin Reiter, Rene Vidal, et al., Preprint 2016.
  [PDF](https://arxiv.org/pdf/1602.02995) [arXiv](https://arxiv.org/abs/1602.02995)
  `fully-supervised` `unknown` `unknown`
  _Status:_ arXiv 1602.02995; first submitted 2016-02-09; last updated 2016-09-30; comment=Updated from the ECCV 2016 version. We fixed an important mathematical error and made the section on segmental inference clearer; journal_ref=none. No formal conference proceedings placement has been verified.
